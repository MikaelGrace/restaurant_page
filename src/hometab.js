...
export function HomePage() {
    ...
    heading.textContent = "Welcome to Savoury Bites";

    const tagline = document.createElement("p");
    tagline.textContent = "Delicious meals, made fresh every day.";

    hero.append(heading, tagline);

    const imgDiv = document.createElement("div");
    imgDiv.classList.add("home-img-div");

    const image1 = document.createElement("img");
    image1.src = "https://www.thefoodpocketguide.com/wp-content/uploads/sandra-wei-pgMKhgvf1O4-unsplash.jpg";
    image1.classList.add("home-img");

    const image2 = document.createElement("img");
    image2.src = "https://cdn.shopify.com/s/files/1/0067/1576/8885/files/nigerian-wedding-dishes-how-to-choose-the-best-dishes-for-your-reception-party_1024x1024.jpg?v=1710256684";
    image2.classList.add("home-img");

    imgDiv.append(image1, image2);
    ...
    aboutText.textContent = "At Savoury Bites, we combine traditional recipes with modern flavors to give you an unforgettable dining experience.";
    ...
    //     // Assuming MenuPage exists
    //     MenuPage();
    // });

    content.append(hero, imgDiv, about);
}
